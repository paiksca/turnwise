...
export const RUBRICS: Record<IndicatorKey, Rubric> = {
  ...
  concession: {
    ...
    valence: "positive",
    plain:
      "Moments where this person actually granted a point to the other side.",
    definition:
    ...
    negativeMarkers: [
      "'Good point, but' where nothing is actually conceded. This is a transition, and no point was granted",
