 ...
 * Indicator rubrics.
 *
 * These definitions are the substance of the tool. You can rewrite the matching
 * code without changing what the tool measures. Editing these definitions
 * changes what the numbers mean.
 *
 * Each indicator names the observable behavior, the markers that count as
 * evidence for and against it, anchors for each point on the 0-4 scale, and
 * the research the construct comes from.
 *
...
export const RUBRICS: Record<IndicatorKey, Rubric> = {
  receptiveness: {
    ...
    definition:
      "Conversational receptiveness is the use of language that communicates willingness to engage thoughtfully with opposing views. It is a property of expression, not of private belief: score what the speaker's words convey to a disagreeing listener, not whether you think they were sincere. Receptiveness is scored only where disagreement is present or invited. Agreeable conversation with nothing at stake is not high receptiveness, it is out of scope for this indicator (score 0 with a note rather than inflating).",
    positiveMarkers: [
    ...
    negativeMarkers: [
      "'I hear you, but' where the acknowledgment is a formality and no part of the other view is engaged. This scores lower than a plain disagreement",
      "Hedging used to evade rather than to open ('I guess whatever you think'). Disengagement does not count as receptiveness",
    ...
    limits:
      "Measures expressed receptiveness in language, which is what the other party experiences. It does not measure sincerity, private open-mindedness, or whether the speaker later changed their mind.",
    provenance: [
      "Yeomans, Minson, Collins, Chen & Gino (2020), 'Conversational receptiveness: Improving engagement with opposing views', Organizational Behavior and Human Decision Processes. Source of the acknowledgment, hedging, agreement, and positive-framing feature set.",
      "Yeomans, Kantor & Tingley (2018), 'The politeness Package: Detecting Politeness in Natural Language', The R Journal. Source of the underlying linguistic markers.",
  ...
  perspective_taking: {
    ...
    valence: "positive",
    plain:
      "How much this person tries to articulate what the world looks like from the other side.",
    definition:
      "An explicit attempt to represent another person's view, reasons, or experience from the inside. The strong form is perspective-GETTING: asking the other person what their experience is and using their answer, rather than imagining it unaided. Score the attempt to represent, not the accuracy of the representation. A representation the other party visibly rejects ('no, that's not it at all') caps the score at 2.",
    positiveMarkers: [
      "Articulating the other's reasoning in a form the other would accept ('so if I'm following, the worry is that...')",
      "Naming the value or fear underneath the other's position, beyond its surface claim",
    ...
    anchors: [
      ...
      "Perspective-getting. The speaker asks about the other's experience, listens, and visibly revises their model of the other's position based on the answer.",
    ],
    limits:
    ...
    provenance: [
      ...
      "Eyal, Steffel & Epley (2018), 'Perspective mistaking', JPSP. Establishes the perspective-getting versus perspective-taking distinction, and why imagined perspective-taking underperforms.",
    ],
  },
  ...
  contempt: {
    ...
    valence: "negative",
    plain:
      "Expressions of superiority or disgust toward the other person.",
    definition:
      "Communication that positions the speaker as superior to the other person, or treats the other as an object of disgust or ridicule. Contempt targets the person. Ordinary disagreement targets the claim. This distinction is the whole indicator, so forceful and even angry disagreement about a position does not count as contempt, while mockery, name-calling, sarcasm at the other's expense, condescension, and dismissing someone as beneath response all do count.",
    positiveMarkers: [
      ...
      "Condescension, meaning explaining something as though to a child, or praising the other for meeting a low bar",
    ...
    negativeMarkers: [
      "Strong, even heated disagreement about a claim, with the person left intact. This does not count as contempt",
      "Expressed anger or hurt about a harm ('that comment hurt me'). This does not count as contempt",
      "Criticism of a public figure or institution not present in the conversation. Score this only if it lands on the person present or their identity",
    ...
    anchors: [
      ...
      "Trace. One ambiguous moment, an edged joke or a flash of condescension, neither repeated nor escalated.",
    ...
    limits:
      "Text-only. Tone of voice, facial expression, and eye-rolling are invisible here, and they are central to how contempt is normally identified. Expect this score to UNDERCOUNT contempt in a transcript of spoken conversation. Sarcasm in particular is unreliable in text, and the confidence value reflects that.",
    provenance: [
  ...
  curiosity: {
    ...
    valence: "positive",
    plain:
      "Whether this person asks about the other, and especially whether they follow up on the answers.",
    definition:
    ...
    negativeMarkers: [
      ...
      "Cross-examination, meaning rapid closed questions building toward a gotcha",
    ...
    anchors: [
      ...
      "Regular genuine questions including some follow-ups that build on what was just said.",
    ...
    provenance: [
      "Huang, Yeomans, Brooks, Minson & Gino (2017), 'It Doesn't Hurt to Ask: Question-Asking Increases Liking', JPSP. Identifies follow-up questions as the strongest liking-relevant question type.",
      "Yeomans, Schweitzer & Brooks (2022), 'The Conversational Circumplex', Current Opinion in Psychology. Treats information exchange as a core conversational dimension.",
    ],
  },
  ...
  concession: {
    ...
    negativeMarkers: [
      "'Good point, but' where nothing is conceded. This is a transition, and no point was granted",
      ...
      "Capitulation under social pressure with no reasoning. Record it and note the pressure in the rationale",
    ],
    anchors: [
      "No concessions.",
      ...
      "Visible movement. The speaker concedes substantively more than once and states a changed or softened position.",
    ],
    limits:
  ...
  personal_disclosure: {
    ...
    positiveMarkers: [
      ...
      "Naming an emotion the speaker felt, tied to an experience",
    ...
    anchors: [
      ...
      "Nominal. Identity claims or category statements with no experience shared.",
      "Some. At least one genuine personal experience, briefly stated or thinly connected to the topic.",
      "Substantive. Multiple specific personal experiences connected to the topic, including some emotional content.",
